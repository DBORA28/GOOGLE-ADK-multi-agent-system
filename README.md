...
## Architecture
- Agent 1: Market Indicator Agent
- Agent 2: Decision Loop Agent
- Agent 3: Profit & Loss Agent
- Agent 4: Risk Assessment Agent
- Agent 5: Recommendation Agent (Final Synthesis)
...
### 1. Clone the repository
    git clone https://github.com/yourusername/stock-research-adk.git
    cd stock-research-adk
...
### Run baseline hallucination evaluation
    export $(cat .env | xargs) && python3 -m evaluation.run_baseline

### Run ablation study
    export $(cat .env | xargs) && python3 -m evaluation.ablation.run_ablation
...
- Answer Relevance (ROUGE)

### Hallucination (Context ↔ Response)
- Groundedness (RAG metric)
- NLI Contradiction Detection
- Token Overlap
- Embedding Context Match
- Citation Validation
- Hallucination Rate
